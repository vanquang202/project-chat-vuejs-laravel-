"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["ChatRoom"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    sendFileChat: function sendFileChat() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.flagFileSend = true;
                _context2.next = 7;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this2.uri + 'api/file-send-chat', formData).then(function (res) {
                  var _res$data$message, _res$data$message2;

                  _this2.message_error = (_res$data$message = res.data.message) !== null && _res$data$message !== void 0 && _res$data$message.file_send[0] ? (_res$data$message2 = res.data.message) === null || _res$data$message2 === void 0 ? void 0 : _res$data$message2.file_send[0] : null;

                  _this2.getRoomDetails();
                })["finally"](function () {
                  document.getElementById('close-modal').click();
                  _this2.flagFileSend = false;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get(_this3.uri + 'api/get-room-details/' + _this3.id + '/?page=' + _this3.page).then(function (res) {
                  ...
                  _this3.roomDetail = res.data.roomDatils;
                  _this3.dataChat = res.data.data;
                  _this3.flag = false;
                  _this3.load = false;
                })["catch"](function (err) {
                  _this3.flag = false;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                formData.append('id_auth', _this4.id_auth);
                ...
                if (file) {
                  ...
                  _this4.changeImg = false;
                  document.getElementById('imageClass').value = null;
                }

                that = _this4;
                _context4.next = 10;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this4.uri + 'api/chat-room-send-data', formData).then(function (res) {
                  that.getRoomDetails();
                  that.data = '';
                })["catch"](function (err) {});
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                formData = new FormData();
                formData.append('pass', _this5.pass);
                formData.append('code', _this5.id);
                _context5.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this5.uri + 'api/change-pass-room', formData).then(function (res) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                formData = new FormData();
                formData.append('code', _this6.id);
                _context6.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this6.uri + 'api/remove-room', formData).then(function (res) {
                  _this6.$router.push({
                    name: 'ContentChat'
                  })["catch"](function () {});
                });
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this7.uri + 'api/view-people-room', formData).then(function (res) {
                  _this7.dataPeople = res.data.userPeople;
                  _this7.dataBoss = res.data.userBoss;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get(_this8.uri + 'api/event-chat-input/' + _this8.id_gr).then(function (res) {})["catch"](function (err) {});
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                formData.append('code', _this9.id);
                _context9.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this9.uri + 'api/out-room', formData).then(function (res) {})["catch"](function (err) {});
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                formData = new FormData();
                formData.append('code', _this10.id);
                _context10.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this10.uri + 'api/out-room', formData).then(function (res) {})["catch"](function (err) {});
          ...
          _c("div", { staticClass: "pro row align-center" }, [
            _c("div", { staticClass: "col-sm-5" }, [
              _c("h2", { staticClass: "p-2" }, [
                _vm._v(
                  "\n          " +
                    _vm._s(_vm.roomDetail.name_room) +
                    "\n          "
                ),
                _c("span", { staticStyle: { "font-size": "15px" } }, [
                  _vm._v(
                    "\n            RoomId : " +
                      _vm._s(_vm.roomDetail.code_room) +
                      "\n          "
                  ),
                ]),
              ]),
                  ...
                  _c("div", { staticClass: "offcanvas-body" }, [
                    _c("div", [
                      ...
                      _c("img", {
                        ...
                        on: {
                          click: function ($event) {
                            return _vm.viewProfile(_vm.dataBoss.id)
                          },
                        },
                      }),
                      _vm._v(" "),
                ...
                _vm._l(_vm.dataChat, function (data, index) {
                  return _c(
                    ...
                    [
                      ...
                      index == 0 ||
                      data.me_id !=
                        _vm.dataChat[index - 1 < 0 ? 0 : index - 1].me_id
                        ? _c(
                            "h3",
                            {
                              style: {
                      ...
                      _vm._l(data.view, function (i, k) {
                        return data.view[0] != 0
                          ? _c(
                              ...
                              [
                                _vm.dataChat.length == index + 1 ||
                                _vm.dataChat[index + 1].view.filter(function (
                                  data
                                ) {
          ...
          _c(
            ...
            [
              _c(
                "form",
                {
                  staticClass: "col-sm-1 row formSend",
