"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_main_Chat_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.getRoom();
    var that = this; // Echo.channel('channel-send-'+id_me)
    //     .listen('SendChat', function () {
    //         that.getRoom();
    //     })
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get(_this.uri + 'api/room/' + _this.id).then(function (res) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                that = _this2;
                _context2.next = 10;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this2.uri + 'api/room', formData).then(function (res) {
                  that.data = '';
                })["catch"](function (err) {});
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get(_this3.uri + 'api/event-chat-input/' + _this3.id).then(function (res) {})["catch"](function (err) {});
