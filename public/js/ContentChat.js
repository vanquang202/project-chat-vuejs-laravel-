"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["ContentChat"],{
            ...
            _vm._l(_vm.userDeloyFriend, function (you, index) {
              return _c(
                "div",
                {
                  ...
                  staticStyle: { "margin-top": "20px", cursor: "pointer" },
                  on: {
                    click: function ($event) {
                      if ($event.target !== $event.currentTarget) {
                        return null
                      }
                      return _vm.viewProfile(you.user.id)
                    },
                  },
                },
                [
                  _c("div", { staticClass: "col-sm-2" }, [
                    you.user.image !== "default.png"
                      ? _c("img", {
                          attrs: {
                            width: "100%",
